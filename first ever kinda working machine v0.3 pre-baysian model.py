...
# this function takes in a string and then for each of the characters you want to separate it with spaces it goes through
# the string and separates them, the string becomes a new string with those characters separated with spaces.
...
print ("expanded around characters successfully")


#####
##3## Create a dataframe which counts up the occurrences of each word in each rating category and normalise the vectors
#####
...
def word_tally1(documents, ratings_index):
    ...
    for i in range (len (documents)):
        ...
        for word in split_document:
            ...
            if word == "yes" and ratings_index[i] == 4:
                hell_count += 1
...
print ("the time to make the dataframe is: ", x - y)

print ("\n\n")

print ("THIS SHOULD NOT BE NORMALISED: ")
print ("the vector for the word 'wonderful': ", ratings_map["wonderful"])
...
print ("THIS SHOULD BE NORMALISED...:")
...
#chuck a while True in here to loop it over and over
